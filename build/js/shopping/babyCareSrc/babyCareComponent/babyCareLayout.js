//  Function to generate the baby care contents
export function generateBabyCareLayoutHTML(product, index, totalLength) {
             ...
             <a href="/products/?id=${product.id}" 
                ...
                <div>
                    <a href="/products/?id=${product.id}" 
                        ...
                        <p class="letter-spacing h-7 text-ellipsis line-clamp-2 text-center lg:text-start font-medium text-[15px]">${product.productName}</p>
