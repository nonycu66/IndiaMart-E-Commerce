import { beautyProductData } from '../data/beautyProductData.js';

//  Function to generate the beauty products layout contents dynamically
export function generateBeautyProductLayoutHTML() {
	let beautyProductHTML = '';

	beautyProductData.forEach((product, index) => {
		const isLastItem = index === beautyProductData.length - 1;
