import { homeDecorSecond } from '../../data/homeDecorData.js';

// function to generate items for the home decor bottom left dynamically
export function generateHomeDecorBottomLeft() {
	let footWearCard = '';

	homeDecorSecond.forEach((homedecor) => {
		footWearCard =
			footWearCard +
			` 
