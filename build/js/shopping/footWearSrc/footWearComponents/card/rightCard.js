import { footWearDataFifth } from '../../data/footWearData.js';
// function to generate items for the foot wear right dynamically
export function generateFootWearRight() {
	let footWearCard = '';

	footWearDataFifth.forEach((footwear) => {
		footWearCard =
			footWearCard +
			`
             <ul class="max-w-[213px] md:max-w-[256px] lg:mb-[30px]">
