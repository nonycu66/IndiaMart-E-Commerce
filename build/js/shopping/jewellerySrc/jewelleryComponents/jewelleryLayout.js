...
//  Function to generate the jewellery layout contents dynamically
export function generateJewelleryLayoutHTML() {
	let jewelleryHTML = '';

	jewelleryData.forEach((product, index) => {
		const isLastItem = index === jewelleryData.length - 1;
