import { generateJewelleryLayoutHTML } from '../jewelleryComponents/jewelleryLayout.js';

// Function to render the jewellery products layout contents
export function renderJewelleryLayoutHTML() {
	...
	topDiv.innerHTML = ` 
            <i class="cursor-pointer flex items-center justify-center rounded-[50%] mr-[15px] shadow-ladies-wear-box-shadow">
              <img
               src="/build/img/artificial-jewellery.png"
                alt="Ladies Wear"
				loading="lazy"
                 />
             </i>
	...
	// Generate the jewellery products html dynamically and insert it into the variable
	const jewelleryContents = generateJewelleryLayoutHTML();

	// Insert jewelleryContents into the articleElemInner variable
	articleElemInnerDiv.innerHTML = jewelleryContents;
