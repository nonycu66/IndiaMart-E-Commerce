import { babyCareData } from '../data/babyCareData.js';
import { generateBabyCareLayoutHTML } from '../babyCareComponent/babyCareLayout.js';

// Function to render the baby care layout contents
export function renderBabyCareLayoutHTML() {
	...
	// Loop through the babyCareData array and generate the items dynamically
	babyCareData.forEach((product, index) => {
		const productItems = generateBabyCareLayoutHTML(
			product,
			index,
			babyCareData.length
		);
