import { footWearDataFourth } from '../../data/footWearData.js';

// function to generate items for the foot wear center top dynamically
export function generateFootWearCenterTop() {
	let footWearCard = '';

	footWearDataFourth.forEach((footwear) => {
		footWearCard =
			footWearCard +
			`
                 <ul class="max-w-[213px] md:max-w-[256px] lg:min-w-[475px] lg:max-w-[475px] shadow-none lg:mr-7 lg:mb-6 rounded-[10px] border-t border-solid border-[#f7f4f4]">
                    ...
                    <a href="#" class="block pt-[10px] text-[#111]">
                        ...
                        <span class="db">${footwear.storeName}</span>
                        </p>
                    </a>
