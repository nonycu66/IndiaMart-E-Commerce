import { generateFootWearTopLeft } from '../footWearComponents/card/topLeftCard.js';
import { generateFootWearBottomLeft } from '../footWearComponents/card/bottomLeftCard.js';
import { generateFootWearCenterBottom } from '../footWearComponents/card/centerBottom.js';
import { generateFootWearCenterTop } from '../footWearComponents/card/centerTop.js';
import { generateFootWearRight } from '../footWearComponents/card/rightCard.js';
import { renderFrameView } from '../../shared/frameView.js';
import { renderFormView } from '../../shared/formView.js';
// Function to render the foot wear content elements dynamically
export function renderFootWearHTML() {
	...
	topDiv.innerHTML = ` 
            <i class="cursor-pointer flex items-center justify-center rounded-[50%] mr-[15px] shadow-ladies-wear-box-shadow">
              <img
               src="/build/img/footwear.png"
                alt="Ladies Wear"
			      loading="lazy"
                 />
             </i>
             <h2 class="text-base font-medium lg:text-[27px] lg:font-bold">Footwear</h2>
    `;
	...
	// Call the generateFootWearTopLeft function and insert it into the variable
	const topLeftFootWear = generateFootWearTopLeft();
	// Set articleElemFirst inner html to topLeftFootWear
	articleElemFirst.innerHTML = topLeftFootWear;
	...
	// Call the generateFootWearBottomLeft function and insert it into the variable
	const bottomLeftFootWear = generateFootWearBottomLeft();
	// Set the articleElemSecond inner html to bottomLeftFootWear
	articleElemSecond.innerHTML = bottomLeftFootWear;
	...
	// Call the generateFootWearCenterBottom function and insert it into the variable
	const centerBottomFootWear = generateFootWearCenterBottom();
	// Set the articleElemThird inner html to CenterBottomFootWear
	articleElemThird.innerHTML = centerBottomFootWear;
	...
	// Call the generateFootWearCenterTop function and insert it into the variable
	const centerTopFootWear = generateFootWearCenterTop();
	// Set the articleElemFourth inner html to CenterTopFootWear
	articleElemFourth.innerHTML = centerTopFootWear;
	...
	// Call the generateFootWearRight function and insert it into the variable
	const rightFootWear = generateFootWearRight();
	// Set the articleElemFifth inner html to rightFootWear
	articleElemFifth.innerHTML = rightFootWear;
